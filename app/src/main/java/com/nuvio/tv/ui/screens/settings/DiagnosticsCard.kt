...
internal fun LazyListScope.diagnosticsCardItems(
        ...
        DiagnosticsSectionCard {
            ...
            DiagnosticRow(
                ...
                dv(
                    ...
                    // DV7 F3: "not available" misled -- devices like the S905X4
                    // decode P7 natively without advertising the profile.
                    else stringResource(R.string.diag_value_not_advertised)
                )
            )
            // DV7 F3: enhancement-layer type of the last DV7 stream, and the
    ...
    item(key = "diag_card_decision") {
        DiagnosticsSectionCard {
            ...
            // this stream. Reporting CONVERT_TO_DV81 / DV81_LIBDOVI on a native Profile 8
            // source that the extractor never touched (shouldConvert() returns false for any
            // profile but 7) read as "conversion applied" and cost hours of misdirection. This
