...
internal fun LazyListScope.subtitleSettingsItems(
    ...
    item(key = "subtitle_addon_subtitles") {
        ToggleSettingsItem(
            icon = Icons.Default.Subtitles,
            title = stringResource(R.string.sub_addon_subtitles),
            subtitle = stringResource(R.string.sub_addon_subtitles_desc),
            isChecked = playerSettings.addonSubtitlesEnabled,
            onCheckedChange = onSetAddonSubtitlesEnabled,
            onFocused = onItemFocused,
            enabled = enabled
        )
    }
    ...
    item(key = "subtitle_startup_mode") {
        NavigationSettingsItem(
            ...
            onFocused = onItemFocused,
            enabled = enabled && playerSettings.addonSubtitlesEnabled
        )
    }
