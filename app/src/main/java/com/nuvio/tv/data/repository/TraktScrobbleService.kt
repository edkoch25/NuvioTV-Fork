...
class TraktScrobbleService @Inject constructor(
    ...
    internal fun shouldSkipDecision(
        ...
        // compared stop-against-stop and was dropped, leaving Trakt holding
        // "playing". Diagnosed on the MDBList sink 2026-07-31; this sink shares
        // the dedup design and therefore the defect.
