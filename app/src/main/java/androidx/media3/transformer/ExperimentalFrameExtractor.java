/*
 * Vendored verbatim from androidx/media (media3) 1.8.0:
 *   libraries/transformer/src/main/java/androidx/media3/transformer/ExperimentalFrameExtractor.java
 * Upstream source SHA-256: 5af2b7a711818f9a79df620122f28584c1585cd4820512552813a3f56ad6f687
 *
 ...
 *
 * Vendored unmodified into NuvioTV-Fork (GPL-3.0-or-later) for the seek-thumbnail workstream
 * (T-series). Apache-2.0 is compatible with GPL-3.0. The copy is owned so its hardcoded
 * DefaultMediaSourceFactory can be made injectable in a later build; Build 1 keeps it
